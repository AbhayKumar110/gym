...
<html>
 ...
 <div class="jumbotron" style="border-radius:0;background:url('images/jakob-owens-qkQwDvRqQY8-unsplash.jpg');background-size:cover;height:400px;"></div>
   <div class="container-fluid">
    <div class="row">
     ...
     <div class="card-body" style="background-color:#3498DB;color:#292930;">
     <center>
                ...
                <style>
                  <body>
                    background-color:powderblue;ss
                  </body>
                </style>
				        ...
				        if (isset($_SESSION['u_id'])) {
						  echo '<form action="includes/index.php" method="POST">
							...
							echo '<form action="includes/index.php" method="POST">
				              ...
				              <a href="index.php" class="btn btn-light" style="background-color:#E12B38;color:#aabbac">Logout</a>';
